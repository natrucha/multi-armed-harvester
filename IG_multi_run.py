...
def singleRun(seed, distribution, density, Td, v_vy, n_arm, cell_l, horizon_l, travel_l):
    ...
    # v_vy   = 0.3      # in m/s vehicle velocity -> max 0.9 m/s #### SET ABOVE ####
    ...
    # density = 4 #13.333      # fruit/m^3, average density of whole orchard #### SET ABOVE ####
    ...
    #     # snapshot_fruit_picked_by = sched.chooseArm4Fruit()
        ...
        # sched.calculateStateTime(snapshot_fruit_picked_by)  ### NOT REALLY FOR MELON ###
    #     # # combine results
    ...
    #### PLOTS OVER-WRITE, FIX IF NEEDED ####
    # results.avgPCT()
    # print()
    ...
    # to return for Data Analysis:
    return([realFPE, realFPT])


def monteCarlo_numRun(print_out, n_runs, seed_list, distribution, density, Td, v_vy, n_arm, cell_l, vehicle_l, horizon_l, travel_l):
    ...
    if print_out == 1:
        ...
        print('The vehicle velocity was set at', v_vy, 'm/s')
...
def main():
    ...
    # 3     == multiple densities (only melon for now)
    # 4     == fruit in vertical columns
    distribution = 1  # number of densities to be analyzed (1 vs 3)
    ...
    n_runs = 5  # number of times simulation is run 
    ...
    # monteCarlo_numRun(print_out, n_runs, seed_list, distribution, density, Td, v_vy, n_arm, cell_l, vehicle_l, horizon_l, travel_l)
